...
public class PasswordOriginal {
    ...
    public static int countTries(int totalTries) {
        int leftTries = maxTries-totalTries-1;
        return leftTries;
    ...
    public static void main(String[] args) {
        ...
        if (passInput.equals(password)) {
            ...
            if (numTries == (maxTries-1)) {
                ...
                System.out.println("Wrong password, you have " + countTries(numTries) + " tries left");
                numTries++;
                PasswordOriginal.main(args);
            }
        }
